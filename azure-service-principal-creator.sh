...
az ad app permission add --id $APP_ID --api 00000003-0000-0000-c000-000000000000 --api-permissions 7ab1d382-f21e-4acd-a863-ba3e13f7da61=Role --output none # "Directory.Read.All"

az ad app permission grant --id $APP_ID --api 00000003-0000-0000-c000-000000000000 --scope Directory.Read.All --output none

# Windows Azure Active Directory Application Role Access

az ad app permission add --id $APP_ID --api 00000002-0000-0000-c000-000000000000 --api-permissions 3afa6a7d-9b1a-42eb-948e-1650a849e176=Role --output none # "Application.Read.All"
az ad app permission add --id $APP_ID --api 00000002-0000-0000-c000-000000000000 --api-permissions 5778995a-e1bf-45b8-affa-663a9f3f4d04=Role --output none # "Directory.Read.All"

az ad app permission grant --id $APP_ID --api 00000002-0000-0000-c000-000000000000 --scope Application.Read.All,Directory.Read.All --output none
